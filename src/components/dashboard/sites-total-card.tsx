...
export function SitesTotalCard() {
  ...
  return (
    <div className="flex min-h-[7.5rem] min-w-[160px] flex-col items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-4 text-center shadow-sm sm:min-w-[180px]">
